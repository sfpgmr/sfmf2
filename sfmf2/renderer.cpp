...
void window_renderer::create_swap_chain(bool fullscreen)
{
  ...
  CHK(graphics::instance()->dxgi_factory()->CreateSwapChainForHwnd(d3d_device.Get(), (HWND) window_.raw_handle(), &swap_chain_desc_, &swap_chain_fullscreen_desc_, graphics::instance()->dxgi_output().Get(), &dxgi_swap_chain_));
