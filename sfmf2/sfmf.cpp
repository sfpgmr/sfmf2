...
namespace sf {
      ...
      )
  {
    ...
    CHK(mediaTypeOut_->SetUINT32(MF_MT_MPEG2_PROFILE, eAVEncH264VProfile_Main));
    ...
    CHK(sinkWriter_->GetServiceForStream(streamIndex_, MF_RATE_CONTROL_SERVICE, __uuidof(IMFRateSupport), &ptr));
